...
Questões institucionais e técnicas ainda **não decididas**. Não devem ser resolvidas por suposição. Quando uma pendência for resolvida, registre a decisão em `09-DECISOES.md` e atualize o status aqui (não apague a pendência).
...
| PEN-003 | Quem, dentro da igreja, pode abrir uma solicitação de obra | 03, 04 | **Resolvida (DEC-013)** — o Pastor Local abre ou delega; quando delega, segue direto ao Coordenador do Polo, sem aprovação do pastor |
| PEN-004 | Ordem e níveis exatos das aprovações hierárquicas | 03, 05 | **Resolvida (DEC-013)** — quatro etapas: Polo → Área → Região → CONBENS. Alçadas por valor/prioridade e prazos seguem em aberto (ver PEN-028) |
| PEN-005 | Comportamento em caso de rejeição de uma solicitação (devolver para correção, encerrar, reabrir) | 03 | Aberta |
| PEN-006 | Significado operacional de cada prioridade (Emergencial, P1, P2, P3) e se Emergencial altera o fluxo | 03, 05 | Aberta (quem define já está resolvido: pastor responsável da CONBENS — DEC-013) |
| PEN-007 | Papel exato do Presbitério | 03, 04 | **Resolvida (DEC-013)** — o Presbitério não decide no sistema; a análise ocorre no SGI (externo) e o resultado é registrado manualmente |
| PEN-008 | Orçamentos: quantidade mínima e quem elabora | 03 | **Resolvida (DEC-013)** — a igreja solicitante monta 3 cotações de material, 3 de mão de obra e o Croqui, após a aprovação da CONBENS |
| PEN-009 | Nome e conteúdo das cinco fases de execução da obra | 03, 05 | Aberta |
| PEN-010 | Critérios de conclusão/encerramento de uma obra | 03 | Aberta |
...
| PEN-021 | Significado da sigla CONBENS | 03, 04 | **Resolvida (DEC-013)** — Comissão de Bens e Construções. A grafia usada no sistema é "CONBENS"; o responsável escreveu "CONBENS" no resumo da correção — ver PEN-029 |
...
| PEN-025 | Vínculo do usuário com Região/Área/Polo/Igreja nas permissões | 04, 05 | **Resolvida (DEC-014)** — perfil + `vinculoId` vêm do Clerk; o escopo é aplicado na listagem de obras e nas decisões do fluxo |
